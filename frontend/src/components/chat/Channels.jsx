...
const ChannelsField = ({ channels, currentChannelId, showModal }) => {
      ...
      return (
        <React.Fragment key={id}>
          <Nav.Item as="li" className="w-100">
            <Channel id={id} variant={variant} showModal={showModal}>
              <Button
...
const renderModal = ({ modalInfo, hideModal }) => {
  ...
  return <Component id={modalInfo.channelId} hideModal={hideModal} />;
};
